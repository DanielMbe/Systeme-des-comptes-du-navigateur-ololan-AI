...
<head>
    ...
    <title>Ololan account - Delete Ololan Account</title>
...
<body>
    ...
    <section>
        <div id="paperDoc">
            <form action="processaccountdeletion.php" method="post" class="accountDel">
                ...
                <div class="formField">
                    <div class="fieldLabel">
                        <span>
                            After deleting your account you will no longer have access to certains Ololan Services.
                        </span>
                    </div>
                </div>
                <div id="clickSpace">
                    <div></div>
                    <button id="signinButton" type="submit">Delete</button>
                </div>
            </form>
        </div>
    </section>
