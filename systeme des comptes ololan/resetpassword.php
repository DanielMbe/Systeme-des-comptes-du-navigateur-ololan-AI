...
<head>
    ...
    <title>Ololan account - Reset password</title>
...
<body>
    ...
    <section>
        <div id="paperDoc">
            ...
            <form action="processpasswordresetting.php" method="post">
                <?php
                ...
                <div class="formField">
                    <div class="fieldLabel">
                        <label for="firstpasswordset">New password</label>
                    </div>
                    <div class="container">
                        <input type="password" name="firstpasswordset" minlength="8" class="inputField" placeholder="Enter new password" id="firstSet" oninput="isSecure()" required>
                    </div>
                    <div class="inputCheck" style="color: #555555; font-size: 15px;">Password ( Uppercase, Lowercase, Special Character, Number )</div>
                </div>
                <div class="formField">
                    <div class="fieldLabel">
                        <label for="secondpasswordset">Re-enter new password</label>
                    </div>
                    <div class="container">
                        <input type="password" name="secondpasswordset" minlength="8" class="inputField" placeholder="Re-enter new password" id="secondSet" oninput="doesMacth()" required>
                    </div>
                    <div class="inputCheck" id="passwordChecking" style="color: red; font-size: 15px;"></div>
                </div>
                <div id="clickSpace">
                    <div></div>
                    <button id="signinButton" type="submit">Save</button>
                </div>
            </form>
        </div>
    </section>
