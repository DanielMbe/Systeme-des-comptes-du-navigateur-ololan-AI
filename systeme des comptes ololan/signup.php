...
<head>
    ...
    <title>Ololan account - Sign Up</title>
        ...
        <div id="paperDoc">
            ...
            <form action="processsignupform.php" method="POST">
                ...
                <div class="formField">
                    ...
                    <div class="container">
                        <input type="text" name="firstname" class="inputField" placeholder="Enter first name" oninput="hasSpecialCharacters()" required>
                    </div>
                    <div class="inputCheck" style="color: red; font-size: 15px;"></div>
                </div>
                <div class="formField">
                    <div class="fieldLabel">
                    ...
                    <div class="container">
                        <input type="text" name="lastname" class="inputField" placeholder="Enter last name" oninput="hasSpecialCharacters()" required>
                    </div>
                    <div class="inputCheck" style="color: red; font-size: 15px;"></div>
                </div>
                <div class="formField">
                    ...
                    <div class="containerB">
                        <input type="date" name="birthdate" max="2006-01-01" class="inputFieldB" required>
                    </div>
                </div>
                <div class="formField">
                    <div class="fieldLabel">
                    ...
                    <div class="container">
                        <input type="email" name="username" class="inputField" placeholder="Enter e-mail address (username)" required>
                    </div>
                    <div class="inputCheck" style="color: red; font-size: 15px;"></div>
                </div>
                <div class="formField">
                    <div class="fieldLabel">
                        <label for="firstpasswordset">Password</label>
                    </div>
                    <div class="container">
                        <input type="password" name="firstpasswordset" minlength="8" class="inputField" placeholder="Enter password" id="firstSet" oninput="isSecure()" required>
                    </div>
                    <div class="inputCheck" style="color: #555555; font-size: 15px;">Password ( Uppercase, Lowercase, Special Character, Number )</div>
                </div>
                <div class="formField">
                    <div class="fieldLabel">
                        <label for="secondpasswordset">Re-enter password</label>
                    </div>
                    <div class="container">
                        <input type="password" name="secondpasswordset" minlength="8" class="inputField" placeholder="Re-enter password" id="secondSet" oninput="doesMacth()" required>
                    </div>
                    <div class="inputCheck" id="passwordChecking" style="color: red; font-size: 15px;"></div>
                </div>
                <div id="clickSpace">
                    <div></div>
