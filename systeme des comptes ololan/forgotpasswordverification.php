...
<body>
    ...
    <section>
        <div id="paperDoc">
            <form action="processforgotpassword.php" method="post" class="accountValdForm">
                ...
                <div class="formField">
                    <div class="fieldLabel">
                        <span>
                            ...
                            <?php
                                $email = "mailError";
                                if (isset($_SESSION['forgottenemail'])) {
                                    $email = $_SESSION['forgottenemail'];
                                }
                                echo "<strong>" . $email . "</strong>";
                            ?><br>
                            Enter the code in the form below to change your password.
                        </span>
                    </div>
                    <div class="container">
