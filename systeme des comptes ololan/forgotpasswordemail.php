...
<head>
    ...
    <title>Ololan account - Change account's password</title>
...
<body>
    ...
    <section>
        <div id="paperDoc">
            <form action="processforgotemail.php" method="post" class="accountValdForm">
                <div id="containerField">
                    <img alt="verification logo" src="image/emailforgot.png" id="verifyLogo">
                </div>
                <?php
                ...
                <div class="formField">
                    <div class="fieldLabel">
                        <span>
                            Enter the e-mail address of the account you forgot the password.
                        </span>
                    </div>
                    <div class="container">
                        <input type="email" name="forgottenemail" class="inputField" placeholder="Enter your account's e-mail" required>
                    </div>
                </div>
                <div id="clickSpace">
                    <div></div>
                    <button id="signinButton" type="submit">Next</button>
                </div>
            </form>
        </div>
    </section>
