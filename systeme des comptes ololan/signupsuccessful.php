...
<head>
    ...
    <title>Ololan account - Account created successfully</title>
    ...
    <section>
        <div id="paperDoc">
            <div id="logoTitle">
                ...
                <div id="title">Account created</div>
            </div>
            <div id="divForm">
                <div id="containerField">
                    <img alt="check logo" src="image/checkokay.png" id="checkLogo">
                </div>
                <div class="formField">
                    <div class="fieldLabel">
                        <span>
                            Your Ololan account has been created successfully! click to sign in.
                        </span>
                    </div>
                </div>
                <div id="clickSpace">
                    <div></div>
                    <a id="signinLink" href="https://accounts.ololan.com">
                        <div>Sign in</div>
                    </a>
                </div>
            </div>
